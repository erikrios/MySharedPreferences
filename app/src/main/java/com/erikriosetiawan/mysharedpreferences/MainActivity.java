...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tvName, tvAge, tvPhoneNumber,tvEmail, tvIsLoveMu;
    ...
    private void populateView(UserModel userModel) {
        ...
        tvPhoneNumber.setText(userModel.getPhoneNumber().isEmpty() ? "Tidak Ada" : userModel.getPhoneNumber());
    }
